...
const Testimonials = () => {
  ...
  const openNotification = (type) => {
    api[type]({
      message: "Success",
      description: "Thanks For providing review.",
    });
  };
  ...
  const handelSubmit = (e) => {
    ...
    if (!localStorage.getItem("login")) {
      ...
      console.log(formerr);
      axios
        .post("https://backend-2m89y7bts-rishavpattnaik0.vercel.app/user/add", {
  ...
  return (
    <div className="main1">
      ...
      <div className="section">
        ...
        <h6 id="fh6">
          Your review will help us to improve our web hosting quality skills,
      ...
      {submitted ? (
        <button
          type="button"
          className="btn ok btn-primary btn-lg"
          onClick={(e) => hitman(ROUTES.Reviews)}
        >
